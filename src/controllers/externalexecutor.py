...
class ExternalExecutor():
    ...
    def exe(commandlist, resultdelimiter=None):
        """
        ...
        app.logger.debug("comman is :: {}".format(" ".join(commandlist)))

        try:
            _proc = Popen(commandlist, stdout=PIPE, stderr=PIPE)
        ...
        if resultdelimiter:
            ...
            return [l.decode("utf-8") for l in _boutput.readlines()]
